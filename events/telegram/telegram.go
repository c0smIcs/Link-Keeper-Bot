...
import (
	"errors"
	"kemov/LinkKeeperBot/clients/telegram"
...
var (
	...
	ErrUnknownMetaType  = errors.New("Неизвестный тип метаинформации")
)
...
func (p *Processor) Fetch(limit int) ([]events.Event, error) {
	...
	if err != nil {
		return nil, e.Wrap("Не могу получить events", err)
	}
...
func meta(event events.Event) (Meta, error) {
	...
	if !ok {
		return Meta{}, e.Wrap("Не могу получить метаинформацию", ErrUnknownMetaType)
	}
